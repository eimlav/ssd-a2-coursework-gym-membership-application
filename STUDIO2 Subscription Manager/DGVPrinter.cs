...
{    
    ...
    public class DGVPrinter
    {
        ...
        /// <summary>
        /// Font for the title. Default is Calibri, 18pt.
        /// </summary>
        ...
        /// <summary>
        /// Font for the subtitle. Default is Calibri, 12pt.
        /// </summary>
        ...
        /// <summary>
        /// Font for the footer. Default is Calibri, 10pt.
        /// </summary>
        ...
        /// <summary>
        /// Font for the page number, Default is Calibri, 8pt.
        /// </summary>
        ...
        public DGVPrinter()
        {
            ...
            // set default fonts
            pagenofont = new Font("Calibri", 8, FontStyle.Regular, GraphicsUnit.Point);
            pagenocolor = Color.Black;
            titlefont = new Font("Calibri", 18, FontStyle.Bold, GraphicsUnit.Point);
            titlecolor = Color.Black;
            subtitlefont = new Font("Calibri", 12, FontStyle.Bold, GraphicsUnit.Point);
            subtitlecolor = Color.Black;
            footerfont = new Font("Calibri", 10, FontStyle.Bold, GraphicsUnit.Point);
        ...
        private static int PrintPreviewNoDisplayWidth = 0;
        private static int PrintPreviewNoDisplayHeight = 0;
        public void PrintPreviewNoDisplaySize(int width, int height)
        {
            PrintPreviewNoDisplayWidth = width;
            PrintPreviewNoDisplayHeight = height;
        }
        ...
        public void PrintPreviewNoDisplay(DataGridView dgv)
        {
            ...
            if(PrintPreviewNoDisplayWidth != 0 && PrintPreviewNoDisplayHeight != 0)
            {
                PreviewDialog.Width = PrintPreviewNoDisplayWidth;
                PreviewDialog.Height = PrintPreviewNoDisplayHeight;
            }
            else
            {
